...
All TRAPI Responses should have the following structure:
...
async def test_default(temporary_data_storage: Union[str, Path], data_store: str):
    """
    ...
    annotation = await annotation_instance.annotate_trapi(
...
@pytest.mark.asyncio(loop_scope="module")
@pytest.mark.parametrize("data_store", ["trapi_request.json"])
async def test_append(temporary_data_storage: Union[str, Path], data_store: str):
    """
...
@pytest.mark.asyncio(loop_scope="module")
@pytest.mark.parametrize("data_store", ["trapi_request.json"])
async def test_raw(temporary_data_storage: Union[str, Path], data_store: str):
    """
...
@pytest.mark.asyncio(loop_scope="module")
@pytest.mark.parametrize("data_store", ["trapi_request.json"])
async def test_append_and_raw(temporary_data_storage: Union[str, Path], data_store: str):
    """
